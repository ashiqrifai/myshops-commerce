...
import ProductMergeWizard from "@/components/admin/products/ProductMergeWizard";
    ...
    async () => {
      try {
        ...
        if (
          ...
          throw new Error(
            "The generated export file is empty."
          );
        }
      ...
      <main className="mx-auto w-full max-w-[1500px] px-5 py-6 md:px-8">
        <header className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-[#6d7175]">
              Manage catalogue products and sellable variants.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[#babfc3] bg-white px-4 text-sm font-semibold text-[#303030] transition hover:bg-[#f6f6f7]"
            >
              <FileUp
                size={
                  17
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[#babfc3] bg-white px-4 text-sm font-semibold text-[#303030] transition hover:bg-[#f6f6f7] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {exporting ? (
                <LoaderCircle
                  size={
            ...
            <Link
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-[#303030] px-4 text-sm font-semibold text-white transition hover:bg-[#1f1f1f]"
            >
              <Plus
                size={
                  17
        ...
        <section className="mt-6 rounded-2xl border border-[#e1e3e5] bg-white shadow-sm">
          ...
          {selectedProducts.length >
            0 && (
            <div className="flex flex-col gap-3 border-b border-[#e1e3e5] bg-[#fafbfb] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="text-sm">
                ...
                <span className="ml-2 text-[#6d7175]">
                  Selection applies to the current page.
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="h-9 rounded-lg border border-[#babfc3] bg-white px-3 text-sm font-semibold hover:bg-[#f6f6f7]"
                >
                  Clear
                </button>
                ...
                <button
                  ...
                  className="inline-flex h-9 items-center gap-2 rounded-lg bg-[#303030] px-4 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <Layers3
                    size={
                      16
      ...
      <ProductMergeWizard
        ...
        onCompleted={async (
          ...
          window.location.href =
            `/admin/products/${parentProductId}`;
        }}
      />
    </>
  );
